...
# %% ../05_Digestion_profile_per_sequence.ipynb 3
...
# %% ../05_Digestion_profile_per_sequence.ipynb 5
def digestion_profile_from_count_matrix(count_matrix_stacked, mnases, digestion_direction, mother_seq, sequence_as_index=True):
